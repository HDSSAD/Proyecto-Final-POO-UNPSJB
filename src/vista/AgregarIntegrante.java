...
public class AgregarIntegrante extends JDialog {
	...
	public AgregarIntegrante(CtrlAgregarIntegrante ctrlAgregarIntegrante) {
		...
		btnCancelar.addActionListener(this.getCtrlAgregarIntegrante());
		btnCancelar.setBounds(203, 263, 89, 23);
		contentPane.add(btnCancelar);
		
		btnAceptar = new JButton("Aceptar");
		btnAceptar.addActionListener(this.getCtrlAgregarIntegrante());
