...
import controlador.CtrlAgregarPC;
...
public class VistaAgregarPC extends JDialog {

	private static final long serialVersionUID = 1L;
	private CtrlAgregarPC ctrlAgregarPC;
	...
	public VistaAgregarPC(CtrlAgregarPC ctrlAgregarPC) {
		this.setCtrlAgregarPC(ctrlAgregarPC);
		this.setModal(true);
		...
		contentPanel.add(lblIdsSeparadosPor);
		{
			...
			btnAceptar.addActionListener(this.getCtrlAgregarPC());
		...
		}
		{
			...
			btnCancelar.addActionListener(this.getCtrlAgregarPC());
			contentPanel.add(btnCancelar);
			btnCancelar.setActionCommand("Cancel");
		}
	}

	public JTextField getTxtIdComputadora() {
		return txtIdComputadora;
	}

	public void setTxtIdComputadora(JTextField txtIdComputadora) {
	...
	public CtrlAgregarPC getCtrlAgregarPC() {
		return ctrlAgregarPC;
	}

	public void setCtrlAgregarPC(CtrlAgregarPC ctrlAgregarPC) {
		this.ctrlAgregarPC = ctrlAgregarPC;
	}
}
