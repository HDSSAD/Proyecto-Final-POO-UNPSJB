...
public class EditarIntegrante extends JDialog {
	...
	public EditarIntegrante(CtrlEditarIntegrante ctrlEditarIntegrante) {
		...
		btnCancelar.addActionListener(this.getCtrlEditarIntegrante());
		btnCancelar.setBounds(203, 263, 89, 23);
		contentPane.add(btnCancelar);
		
		btnAceptar = new JButton("Aceptar");
		btnAceptar.addActionListener(this.getCtrlEditarIntegrante());
